...
extension ImplementingAMasonryLayout {
    struct MasonryLayout: Layout {
        ...
        func frames(for subviews: Subviews, in totalWidth: Double) -> [CGRect] {
            ...
            print("columnHeights[0]: \(columnHeights[0])")
            print("columnHeights[1]: \(columnHeights[1])")
            print("columnHeights[2]: \(columnHeights[2])")
