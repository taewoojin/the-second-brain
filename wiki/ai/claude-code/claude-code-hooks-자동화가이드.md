...
**출처**: `raw/claude-code-automate-with-hooks.md`
**날짜**: 2026-04-14
**keywords**: hooks, PostToolUse, PreToolUse, SessionStart, Notification, PermissionRequest, matcher, 결정론적 자동화, 프롬프트 기반 hook, 에이전트 기반 hook, HTTP hook
