...
| 서버                                                                                                                                                                      | 설명                                          |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| [Ticket Tailor](https://help.tickettailor.com/en/articles/11892797-how-to-connect-ticket-tailor-to-your-favourite-ai-agent)                                             | 티켓, 주문 등을 관리하는 이벤트 플랫폼                      |
| [Linear](https://linear.app/docs/mcp)                                                                                                                                   | Linear에서 이슈, 프로젝트 및 팀 워크플로우 관리              |
| [Hugging Face](https://huggingface.co/settings/mcp)                                                                                                                     | Hugging Face Hub 및 수천 개의 Gradio 앱에 접근       |
| [Amplitude](https://amplitude.com/docs/analytics/amplitude-mcp)                                                                                                         | Amplitude 데이터 검색, 접근 및 인사이트 획득              |
| [Atlassian Rovo](https://community.atlassian.com/forums/Atlassian-Platform-articles/Using-the-Atlassian-Remote-MCP-Server-beta/ba-p/3005104)                            | Claude에서 Jira & Confluence 접근               |
| [Blockscout](https://github.com/blockscout/mcp-server)                                                                                                                  | 블록체인 데이터 접근 및 분석                            |
| [Cloudflare Developer Platform](https://www.support.cloudflare.com/)                                                                                                    | 컴퓨팅, 스토리지, AI로 애플리케이션 구축                    |
| [Egnyte](https://developers.egnyte.com/docs/Remote_MCP_Server)                                                                                                          | Egnyte 콘텐츠에 안전하게 접근하고 분석                    |
| [Figma](https://help.figma.com/hc/en-us/articles/32132100833559)                                                                                                        | Figma 컨텍스트로 다이어그램 및 더 나은 코드 생성              |
| [Guru](https://help.getguru.com/docs/connecting-gurus-mcp-server)                                                                                                       | 회사 지식 검색 및 상호작용                             |
| [Jotform](https://www.jotform.com/developers/mcp/)                                                                                                                      | Claude에서 폼 생성 및 제출 데이터 분석                   |
| [monday.com](https://developer.monday.com/apps/docs/mondaycom-mcp-integration)                                                                                          | monday.com에서 프로젝트, 보드 및 워크플로우 관리            |
| [Notion](https://developers.notion.com/docs/mcp)                                                                                                                        | Notion 워크스페이스 연결로 검색, 업데이트 및 도구 간 워크플로우 자동화 |
| [PayPal](https://mcp.paypal.com/)                                                                                                                                       | PayPal 결제 플랫폼 접근                            |
| [Stripe](https://docs.stripe.com/mcp)                                                                                                                                   | 결제 처리 및 금융 인프라 도구                           |
| [Supabase](https://supabase.com/docs/guides/getting-started/mcp)                                                                                                        | 데이터베이스, 인증 및 스토리지 관리                        |
| [Vercel](https://vercel.com/docs/mcp/vercel-mcp)                                                                                                                        | Vercel 프로젝트 및 배포 분석, 디버그, 관리                |
| [Wix](https://dev.wix.com/docs/sdk/articles/use-the-wix-mcp/about-the-wix-mcp)                                                                                          | Wix에서 사이트 및 앱 관리 및 구축                       |
| [Coupler.io](https://help.coupler.io/article/592-coupler-local-mcp-server)                                                                                              | 수백 개의 소스에서 비즈니스 데이터 접근                      |
| [Dice](https://www.dice.com/about/mcp)                                                                                                                                  | Dice에서 활성 기술직 채용 공고 탐색                      |
| [Airtable](https://github.com/domdomegg/airtable-mcp-server)                                                                                                            | Airtable 데이터베이스 읽기 및 쓰기                     |
| [Miro](https://developers.miro.com/docs/miro-mcp)                                                                                                                       | Miro 보드에서 콘텐츠 접근 및 생성                       |
| [Port IO](https://docs.port.io/ai-interfaces/port-mcp-server/overview-and-installation)                                                                                 | 컨텍스트 레이크 검색 및 안전한 액션 실행                     |
| [Aiwyn Tax (formerly Column Tax)](https://docs.columntax.com/page/aiwyn-tax-mcp-server)                                                                                 | Aiwyn 세금 엔진으로 연방 및 주 세금 추정                  |
| [Circleback](https://circleback.ai/docs/mcp)                                                                                                                            | 회의 컨텍스트 검색 및 접근                             |
| [Clarify](https://docs.clarify.ai/en/articles/13367278-clarify-mcp)                                                                                                     | CRM 조회, 레코드 생성, 무엇이든 질문                     |
| [Clarity AI](https://clarity-sfdr20-mcp.pro.clarity.ai/)                                                                                                                | 제안된 SFDR 2.0 기준 펀드 분류 시뮬레이션                 |
| [Day AI](https://day.ai/mcp)                                                                                                                                            | CRMx로 잠재 고객 및 기존 고객에 대한 모든 정보 파악            |
| [bioRxiv](https://claude.com/resources/tutorials/using-the-biorxiv-and-medrxiv-connector-in-claude)                                                                     | bioRxiv 및 medRxiv 프리프린트 데이터 접근              |
| [ChEMBL](https://claude.com/resources/tutorials/using-the-chembl-connector-in-claude)                                                                                   | ChEMBL 데이터베이스 접근                            |
| [Clinical Trials](https://claude.com/resources/tutorials/using-the-clinicaltrials-gov-connector-in-claude)                                                              | ClinicalTrials.gov 데이터 접근                   |
| [CMS Coverage](https://claude.com/resources/tutorials/using-the-cms-coverage-connector-in-claude)                                                                       | CMS 커버리지 데이터베이스 접근                          |
| [ICD-10 Codes](https://claude.com/resources/tutorials/using-the-icd-10-connector-in-claude)                                                                             | ICD-10-CM 및 ICD-10-PCS 코드 세트 접근             |
| [NPI Registry](https://claude.com/resources/tutorials/using-the-npi-registry-connector-in-claude)                                                                       | 미국 국가 의료 제공자 식별자(NPI) 레지스트리 접근              |
| [DevRev](https://support.devrev.ai/en-US/devrev/article/ART-21859-remote-mcp-server)                                                                                    | 회사 지식 그래프 검색 및 업데이트                         |
| [Exa](https://docs.exa.ai/reference/exa-mcp)                                                                                                                            | 웹 검색 및 코드 문서 검색                             |
| [Fiscal.ai](https://docs.fiscal.ai/docs/guides/mcp-integration)                                                                                                         | 공개 주식 기본 데이터 정제                             |
| [Granola](https://help.granola.ai/article/granola-mcp#set-up-guide)                                                                                                     | 회의를 위한 AI 메모장                               |
| [Harmonic](https://support.harmonic.ai/en/articles/12785899-harmonic-mcp-server-getting-started-guide)                                                                  | 기업 및 인물 발견, 조사, 데이터 강화                      |
| [Krisp](https://help.krisp.ai/hc/en-us/articles/25416265429660-Krisp-MCP-Supported-tools)                                                                               | 트랜스크립트 및 노트로 회의 컨텍스트 추가                     |
| [Lorikeet](https://docs.lorikeetcx.ai/mcp/mcp-server)                                                                                                                   | 복잡한 비즈니스를 위한 범용 컨시어지                        |
| [LunarCrush](https://lunarcrush.com/developers/api/ai)                                                                                                                  | 검색에 실시간 소셜 미디어 데이터 추가                       |
| [Mem](https://docs.mem.ai/mcp/overview)                                                                                                                                 | 모든 아이디어를 위한 AI 노트북                          |
| [Metaview](https://support.metaview.ai/integrations/mcp-integration/mcp-overview.mdx)                                                                                   | 채용을 위한 AI 플랫폼                               |
| [Midpage Legal Research](https://midpage-docs.apidocumentation.com/documentation/integration/mcp-tools)                                                                 | 법률 조사 수행 및 업무 결과물 생성                        |
| [Scholar Gateway](https://docs.scholargateway.ai/)                                                                                                                      | 학술 연구 및 인용문으로 응답 강화                         |
| [Sprouts Data Intelligence](https://support.sprouts.ai/en/articles/13384582-sprouts-mcp-server-documentation#h_541c149a52)                                              | 쿼리에서 검증된 리드까지 즉시                            |
| [Gainsight (Staircase AI)](https://support.gainsight.com/Staircase_AI/Staircase_AI_Features/Connect_Staircase_AI_to_LLMs_Using_MCP#Install_Staircase_AI_MCP_for_Claude) | 고객 컨텍스트로 AI 워크플로우 강화                        |
| [Sybill](https://api.sybill.ai/docs/mcp.html)                                                                                                                           | 영업 통화, 딜 및 파이프라인에 대해 AI에게 질문                |
| [Vibe Prospecting](https://developers.explorium.ai/mcp-docs/agentsource-mcp)                                                                                            | 기업 및 연락처 데이터 탐색                             |
| [Windsor.ai](https://windsor.ai/introducing-windsor-mcp/#method-1-using-claude-desktop-3)                                                                               | 325개 이상의 마케팅, 분석 및 CRM 데이터 소스 연결            |
| [Gamma](https://gamma.app/docs/Gamma-MCP-Server-Documentation-m6p43kobgzy15zj?mode=doc)                                                                                 | AI로 프레젠테이션, 문서, 소셜, 사이트 생성                  |
| [Lucid](https://help.lucid.co/hc/en-us/articles/42578801807508-Integrate-Lucid-with-AI-tools-using-the-Lucid-MCP-server)                                                | 아이디어 구상, 다이어그램 작성 및 팀 정렬                    |
| [Netlify](https://docs.netlify.com/build/build-with-ai/netlify-mcp-server/)                                                                                             | Netlify에서 웹사이트 생성, 배포, 관리 및 보안              |
| [AWS Marketplace](https://docs.aws.amazon.com/marketplace/latest/APIReference/marketplace-mcp-server.html)                                                              | 클라우드 솔루션 발견, 평가 및 구매                        |
| [Kindora Funder Discovery](https://kindora.co/mcp)                                                                                                                      | 관심 분야를 지원하는 펀더 탐색                           |
| [Omni Analytics](https://docs.omni.co/ai/mcp)                                                                                                                           | Omni 시맨틱 모델을 통해 자연어로 데이터 쿼리                 |
| [ActiveCampaign](https://developers.activecampaign.com/page/mcp)                                                                                                        | 업무 방식을 변혁하는 자율 마케팅                          |
| [Ahrefs](https://docs.ahrefs.com/docs/mcp/reference/introduction)                                                                                                       | SEO 및 AI 검색 분석                              |
| [AirOps](https://docs.airops.com/mcp)                                                                                                                                   | AI 검색에서 이기는 콘텐츠 제작                          |
| [Airwallex Developer](https://www.airwallex.com/docs/developer-tools/ai/developer-mcp)                                                                                  | Claude로 Airwallex 플랫폼 통합                    |
| [Asana](https://developers.asana.com/docs/mcp-server)                                                                                                                   | Asana에 연결하여 태스크, 프로젝트 및 목표 조율               |
| [Attio](https://docs.attio.com/mcp/overview)                                                                                                                            | Claude에서 Attio CRM 검색, 관리 및 업데이트            |
| [Aura](https://docs.getaura.ai/)                                                                                                                                        | 기업 인텔리전스 및 인력 분석                            |
| [Benchling](https://help.benchling.com/hc/en-us/articles/40342713479437-Benchling-MCP)                                                                                  | R&D 데이터, 실험 및 노트북에 연결                       |
| [BioRender](https://help.biorender.com/hc/en-gb/articles/30870978672157-How-to-use-the-BioRender-MCP-connector)                                                         | 과학적 템플릿 및 아이콘 검색 및 사용                       |
| [Bitly](https://dev.bitly.com/bitly-mcp/)                                                                                                                               | 링크 단축, QR 코드 생성 및 성과 추적                     |
| MT Newswires                                                                                                                                                            | 신뢰할 수 있는 실시간 글로벌 금융 뉴스 제공                   |
| [Box](https://developer.box.com/guides/box-mcp)                                                                                                                         | Box 콘텐츠 검색, 접근 및 인사이트 획득                    |
| [Canva](https://www.canva.dev/docs/connect/canva-mcp-server-setup/)                                                                                                     | Canva 디자인 검색, 생성, 자동완성 및 내보내기               |
| [CB Insights](https://mcp.cbinsights.com/)                                                                                                                              | 비공개 기업에 대한 예측 인텔리전스                         |
| [CData Connect AI](https://cloud.cdata.com/docs/Claude-Client.html)                                                                                                     | 350개 소스를 위한 관리형 MCP 플랫폼                     |
| [PubMed](https://support.claude.com/en/)                                                                                                                                | PubMed에서 바이오메디컬 문헌 검색                       |
| [Clay](https://www.notion.so/clayrun/Clay-Claude-MCP-Server-Documentation-2ef7e66eb01480c9820de48041591aeb)                                                             | 잠재 고객 탐색, 계정 조사, 개인화된 아웃리치                  |
| [Clerk](https://clerk.com/docs/guides/ai/mcp/clerk-mcp-server)                                                                                                          | 인증, 조직 및 결제 추가                              |
| [ClickUp](https://help.clickup.com/hc/en-us/articles/33335772678423-What-is-ClickUp-MCP)                                                                                | 팀과 에이전트를 위한 프로젝트 관리 및 협업                    |
| [Cloudinary](https://cloudinary.com/documentation/cloudinary_llm_mcp#available_mcp_servers)                                                                             | 이미지 및 동영상 관리, 변환 및 전달                       |
| [Consensus](https://docs.consensus.app/docs/mcp)                                                                                                                        | 과학 연구 탐색                                    |
| [Context7](https://context7.com/docs/overview)                                                                                                                          | LLM 및 AI 코드 에디터를 위한 최신 문서                   |
| [Crossbeam](https://help.crossbeam.com/en/articles/12601327-crossbeam-mcp-server-beta)                                                                                  | Claude에서 파트너 데이터 및 에코시스템 인사이트 탐색            |
| Crypto.com                                                                                                                                                              | 암호화폐 실시간 가격, 주문, 차트 등                       |
| [Databricks](https://docs.databricks.com/aws/en/generative-ai/mcp/connect-external-services)                                                                            | Unity Catalog 및 Mosaic AI를 사용한 관리형 MCP 서버   |
| [DataGrail](https://docs.datagrail.io/docs/vera/vera-mcp/introduction-and-use)                                                                                          | 프라이버시를 위한 안전한 프로덕션 AI 오케스트레이션               |
| [Enterpret Wisdom](https://helpcenter.enterpret.com/en/articles/12665166-wisdom-mcp-server)                                                                             | 고객 통합 피드백으로 답변 획득                           |
| [Fever Event Discovery](https://developer.feverup.com/)                                                                                                                 | 전 세계 라이브 엔터테인먼트 이벤트 발견                      |
| [Glean](https://docs.glean.com/administration/platform/mcp/about)                                                                                                       | 엔터프라이즈 컨텍스트를 Claude 및 AI 도구에 가져오기           |
| [GoCardless](https://developer.gocardless.com/developer-tools/mcp/)                                                                                                     | GoCardless 결제 API 통합 구축                     |
| [GoDaddy](https://developer.godaddy.com/mcp)                                                                                                                            | 도메인 검색 및 가용성 확인                             |
| [Google Cloud BigQuery](https://cloud.google.com/bigquery/docs/use-bigquery-mcp)                                                                                        | BigQuery: 에이전트를 위한 고급 분석 인사이트               |
| [Granted](https://grantedai.com/mcp)                                                                                                                                    | 모든 보조금 기회 발견                                |
| [IFTTT](https://ift.tt/ai_assistants)                                                                                                                                   | 1,000개 이상의 앱 연결, 제어 및 자동화                   |
| [Medidata](https://learn.medidata.com/en-US/bundle/mcp-server-documentation/page/medidata_mcp_server_documentation.html)                                                | 임상 시험 소프트웨어 및 사이트 순위 도구                     |
| [Intercom](https://developers.intercom.com/docs/guides/mcp)                                                                                                             | 더 나은 고객 인사이트를 위한 Intercom 데이터 접근            |
| [PlayMCP](https://www.notion.so/2189b97b4888803dbbdcef264e7eff58)                                                                                                       | 도구 상자에서 PlayMCP 서버 연결 및 사용                  |
| [Klaviyo](https://developers.klaviyo.com/en/docs/klaviyo_mcp_server)                                                                                                    | 실시간 Klaviyo 데이터로 보고, 전략 수립 및 생성             |
| lastminute.com                                                                                                                                                          | 항공편, 다이나믹 패키지 및 호텔 검색, 비교, 예약               |
| [LILT](https://support.lilt.com/kb/LILT-mcp)                                                                                                                            | 사람 검증을 통한 고품질 번역                            |
| [Local Falcon](https://github.com/local-falcon/mcp)                                                                                                                     | AI 가시성 및 로컬 검색 인텔리전스 플랫폼                    |
| [Lumin](https://github.com/luminpdf/lumin-mcp-server)                                                                                                                   | 문서 관리, 서명 요청 전송 및 Markdown을 PDF로 변환         |
| [Magic Patterns](https://www.magicpatterns.com/docs/documentation/features/mcp-server/overview)                                                                         | Magic Patterns 디자인 논의 및 반복                  |
| [MailerLite](https://developers.mailerlite.com/mcp/#how-mcp-works)                                                                                                      | Claude를 이메일 마케팅 어시스턴트로 활용                   |
| [Make](https://developers.make.com/mcp-server/)                                                                                                                         | Make 시나리오 실행 및 Make 계정 관리                   |
| [Melon](https://tech.kakaoent.com/ai/using-melon-mcp-server-en/)                                                                                                        | 음악 차트 및 개인화된 음악 추천 탐색                       |
| [Mercury](https://docs.mercury.com/docs/connecting-mercury-mcp)                                                                                                         | Mercury에서 재무 데이터 검색, 분석 및 이해                |
| [Microsoft Learn](https://learn.microsoft.com/en-us/training/support/mcp)                                                                                               | 개발을 강화하는 신뢰할 수 있는 Microsoft 문서 검색           |
| [Mixpanel](https://docs.mixpanel.com/docs/features/mcp)                                                                                                                 | Mixpanel 데이터 분석, 쿼리 및 관리                    |
| [MotherDuck](https://motherduck.com/docs/sql-reference/mcp/)                                                                                                            | 데이터에서 답변 획득                                 |
| [NetSuite](https://docs.oracle.com/en/cloud/saas/netsuite/ns-online-help/article_7200233106.html)                                                                       | 분석 및 인사이트를 위해 Claude를 NetSuite 데이터에 연결      |
| [Owkin](https://docs.owkin.com/core-features-and-usage)                                                                                                                 | 생물학을 위해 구축된 AI 에이전트와 상호작용                   |
| [Pigment](https://kb.pigment.com/docs/mcp-server)                                                                                                                       | 비즈니스 데이터 분석                                 |
| [Postman](https://github.com/postmanlabs/postman-mcp-server)                                                                                                            | 코딩 에이전트에 API 컨텍스트 제공                        |
| Quartr                                                                                                                                                                  | 기업 조사를 위한 금융 데이터 및 AI 인프라                   |
| [Ramp](https://docs.ramp.com/developer-api/v1/guides/ramp-mcp-remote)                                                                                                   | Ramp 재무 데이터 검색, 접근 및 분석                     |
| [Similarweb](https://docs.similarweb.com/api-v5/mcp/mcp-setup)                                                                                                          | 실시간 웹, 모바일 앱 및 시장 데이터                       |
| [Slack](https://docs.slack.dev/ai/mcp-server)                                                                                                                           | 메시지 전송, 캔버스 생성 및 Slack 데이터 가져오기             |
| [Smartsheet](https://help.smartsheet.com/articles/2483663-use-smartsheet-connector-claude)                                                                              | Claude로 Smartsheet 데이터 분석 및 관리              |
| [Snowflake](https://docs.snowflake.com/en/user-guide/snowflake-cortex/cortex-agents-mcp)                                                                                | 구조화 및 비구조화 데이터 검색                           |
| [AdisInsight](https://adisinsight-mcp.springer.com/)                                                                                                                    | 의약품 및 임상 시험 인텔리전스                           |
| [Square](https://developer.squareup.com/docs/mcp)                                                                                                                       | 거래, 가맹점 및 결제 데이터 검색 및 관리                    |
| [Tavily](https://docs.tavily.com/documentation/mcp)                                                                                                                     | AI 에이전트를 웹에 연결                              |
| [pg-aiguide](https://github.com/timescale/pg-aiguide)                                                                                                                   | pg 및 Tiger 문서 검색, 데이터베이스 스킬 학습              |
| Trivago                                                                                                                                                                 | 최적의 가격으로 이상적인 호텔 탐색                         |
| [Udemy Business](https://business-support.udemy.com/hc/en-us/articles/34213384429335-How-to-Integrate-the-Udemy-Business-MCP-Server-With-Your-AI-Tool)                  | 스킬 개발 리소스 검색 및 탐색                           |
| [Pylon](https://support.usepylon.com/articles/2407390554-connecting-to-the-pylon-mcp-server)                                                                            | Pylon 지원 이슈 검색 및 관리                         |
| [Visier](https://docs.visier.com/developer/agents/mcp/mcp-server.htm)                                                                                                   | 인력, 생산성 및 비즈니스 영향 인사이트 탐색                   |
| [Webflow](https://developers.webflow.com/mcp/v1.0.0/reference/overview)                                                                                                 | Webflow CMS, 페이지, 에셋 및 사이트 관리               |
| [WordPress.com](https://developer.wordpress.com/docs/mcp/)                                                                                                              | WordPress.com 사이트를 안전하게 AI로 관리              |
| [Workato](https://docs.workato.com/en/mcp.html)                                                                                                                         | 워크플로우 자동화 및 비즈니스 앱 연결                       |
| [Wyndham Hotels and Resorts](https://www.wyndhamhotels.com/mcp-doc)                                                                                                     | 더 빠르게 최적의 Wyndham 호텔 발견                     |
| [Zapier](https://docs.zapier.com/mcp/home)                                                                                                                              | 대화를 통해 수천 개의 앱에서 워크플로우 자동화                  |
| [Zoho Books](https://help.zoho.com/portal/en/kb/mcp/getting-started/articles/zoho-mcp-help-documentation-29-9-2025)                                                     | 스마트 재무 운영을 위한 Zoho Books MCP                |
| [Zoho CRM](https://help.zoho.com/portal/en/kb/mcp/getting-started/articles/zoho-mcp-help-documentation-29-9-2025)                                                       | Zoho CRM 워크플로우를 위한 MCP 서버                   |
| [Zoho Desk](https://help.zoho.com/portal/en/kb/mcp/getting-started/articles/zoho-mcp-help-documentation-29-9-2025)                                                      | 고객 지원 자동화를 위한 Zoho Desk MCP                 |
| [Zoho Projects](https://help.zoho.com/portal/en/kb/mcp/getting-started/articles/zoho-mcp-help-documentation-29-9-2025)                                                  | 태스크 및 프로젝트 자동화를 위한 Zoho Projects MCP        |
| [ZoomInfo](https://docs.zoominfo.com/docs/zi-api-mcp-overview/)                                                                                                         | GTM 인텔리전스로 연락처 및 계정 강화                      |
| [Jam](https://jam.dev/docs/debug-a-jam/mcp)                                                                                                                             | 화면 녹화 및 이슈에 대한 자동 컨텍스트 수집                   |
| [PlanetScale](https://planetscale.com/docs/connect/mcp)                                                                                                                 | Postgres 및 MySQL DB에 인증된 접근                 |
| [Sentry](https://docs.sentry.io/product/sentry-mcp/)                                                                                                                    | 오류 지능적으로 검색, 쿼리 및 디버그                       |
| [Craft](https://documents.craft.me/jWeCVJrSfxFRuA)                                                                                                                      | 노트 및 세컨드 브레인                                |
| [MoSPI](https://www.datainnovation.mospi.gov.in/mospi-mcp)                                                                                                              | 자연어로 인도 공식 통계 접근                            |
| [GraphOS MCP Tools](https://www.apollographql.com/docs/graphos/platform/graphos-mcp-tools)                                                                              | Apollo 문서, 사양 및 모범 사례 검색                    |
| [Customer.io](https://docs.customer.io/ai/mcp-server/)                                                                                                                  | Claude를 통해 고객 데이터 탐색 및 인사이트 생성              |
| [PostHog](https://posthog.com/docs/model-context-protocol)                                                                                                              | PostHog 인사이트 쿼리, 분석 및 관리                    |
| [Honeycomb](https://docs.honeycomb.io/troubleshoot/product-lifecycle/beta/mcp/)                                                                                         | 옵저버빌리티 데이터 및 SLO 쿼리 및 탐색                    |
| [incident.io](https://docs.incident.io/ai/remote-mcp)                                                                                                                   | incident.io에서 모든 것을 확인하고 관리                 |
| [n8n](https://docs.n8n.io/advanced-ai/accessing-n8n-mcp-server/)                                                                                                        | n8n 워크플로우 접근 및 실행                           |
| [Outreach](https://support.outreach.io/hc/en-us/articles/46370115253403-Outreach-MCP-Server)                                                                            | Outreach AI로 팀 최고 성과 달성                     |
| [Pendo](https://support.pendo.io/hc/en-us/articles/41102236924955)                                                                                                      | 제품 및 사용자 인사이트를 위해 Pendo에 연결                 |
| [Sanity](https://www.sanity.io/docs/ai/mcp-server)                                                                                                                      | Sanity에서 구조화된 콘텐츠 생성, 쿼리 및 관리               |
| [Starburst](https://docs.starburst.io/starburst-galaxy/ai-workflows/mcp-server.html)                                                                                    | 연합 데이터 소스에서 안전하게 데이터 검색                     |
| [Unthread](https://docs.unthread.io/docs/unthread-ai/unthread-mcp)                                                                                                      | 지원 티켓 관리 및 자동화                              |
| [Zocks](https://help.zocks.io/en/articles/14075856-connect-to-the-zocks-mcp-server)                                                                                     | 고객 대화, 패턴 및 인사이트 분석                         |
| [Candid](https://support.claude.com/en/articles/12923235-using-the-candid-connector-in-claude)                                                                          | Candid 데이터를 활용한 비영리 단체 및 펀더 조사              |
| [Open Targets](https://github.com/opentargets/open-targets-platform-mcp)                                                                                                | 약물 표적 발견 및 우선순위 지정 플랫폼                      |
| [Synapse.org](https://github.com/susheel/synapse-mcp?tab=readme-ov-file#synapse-mcp-server)                                                                             | Synapse 과학 데이터 검색 및 메타데이터 도구                |
| [Chronograph](https://lp-help.chronograph.pe/article/735-chronograph-mcp)                                                                                               | Claude에서 Chronograph 데이터와 직접 상호작용           |
| [Hex](https://learn.hex.tech/docs/administration/mcp-server)                                                                                                            | Hex 에이전트로 질문에 답변                            |
...
[플러그인](https://code.claude.com/docs/ko/plugins) 은 MCP 서버를 번들로 제공할 수 있으며, 플러그인이 활성화되면 도구 및 통합을 자동으로 제공합니다. 플러그인 MCP 서버는 사용자 구성 서버와 동일하게 작동합니다.
...
리소스 요청에 자동으로 응답하려면 [`Elicitation` 훅](https://code.claude.com/docs/ko/hooks#Elicitation) 을 사용하세요.
...
MCP 서버를 구축하는 경우 Tool Search가 활성화되면 서버 지침 필드가 더 유용해집니다. 서버 지침은 Claude가 [skills](https://code.claude.com/docs/ko/skills) 의 작동 방식과 유사하게 도구를 검색할 시기를 이해하는 데 도움이 됩니다.
...
또는 [settings.json `env` 필드](https://code.claude.com/docs/ko/settings#available-settings) 에서 값을 설정합니다.
